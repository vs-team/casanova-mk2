...
// build a LexFilter
//--------------------------------------------------------------------------*)
type LexFilterImpl (lightSyntaxStatus:LightSyntaxStatus, compilingFsLib, lexer, lexbuf: LexBuffer<char>)  = 
...
type LexFilter (lightSyntaxStatus:LightSyntaxStatus, compilingFsLib, lexer : (LexBuffer<char> -> CasanovaCompiler.Parser.token) , lexbuf: LexBuffer<char>)  = 
