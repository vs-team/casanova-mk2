...
public class UnityNetworkManager : MonoBehaviour
{
  ...
  public List<Message> ListOutGoingMessages
  {
    get { return this.OutgoingMessages; }
    set { this.OutgoingMessages = value; }
  }

  public List<Message> ListIncomingMessages
  {
    get { return this.IncomingMessages; }
    set { this.IncomingMessages = value; }
  }
  ...
  public static UnityNetworkManager Instantiate()
  {
    ...
    public Pair<bool, int> getTypeIdentity<T>(T element)
    {
    ...
    public void Send<T>(T element, NetClient client, Func<T, NetClient, bool, NetOutgoingMessage> messageFunction)
    {
      NetOutgoingMessage message = messageFunction(element, client, true);
      client.SendMessage(message, NetDeliveryMethod.ReliableOrdered);
    }

    public void Send<T>(List<T> list, NetClient client, Func<T, NetClient, bool, NetOutgoingMessage> messageFunction)
    {
    ...
    public NetOutgoingMessage BuildMessage(float f, NetClient client, bool createHeader)
    {
      NetOutgoingMessage message = client.CreateMessage();
    ...
    public NetOutgoingMessage BuildMessage(string s, NetClient client, bool createHeader)
    {
      NetOutgoingMessage message = client.CreateMessage();
      if (createHeader)
      {
    ...
    public NetOutgoingMessage BuildMessage(int i, NetClient client, bool createHeader)
    {
      NetOutgoingMessage message = client.CreateMessage();
      if (createHeader)
      {
    ...
    public NetOutgoingMessage BuildMessage<T>(List<T> list, NetClient client, bool e, Func<T, NetClient, bool, NetOutgoingMessage> messageFunction)
    {
      NetOutgoingMessage message = client.CreateMessage();
    ...
    public NetOutgoingMessage BuildMessage<T>(T element, NetClient client, bool e)
    {
      NetOutgoingMessage message = client.CreateMessage();
      message.Write((int)DataFormat.Element);
      if (e == true)
    ...
    public Vector3 ReceiveVector3(NetIncomingMessage message)
    {
    ...
    public float ReceiveFloat(NetIncomingMessage message)
    {
      float f = message.ReadFloat();
      return f;
    }

    public int ReceiveInt(NetIncomingMessage message)
    {
      int i = message.ReadInt32();
      return i;
    }

    public string ReceiveString(NetIncomingMessage message)
    {
      string s = message.ReadString();
      return s;
    }

    public List<T> ReceiveList<T>(NetIncomingMessage message, Func<NetIncomingMessage, T> decodeFunction)
    {
  ...
  public static void callRunReader(UnityNetworkManager n)
  {
    n.RunReader();
  }
