...
public MainCamera()
  ...
  set{UnityCamera.hideFlags = value; }
	...
	public UnityEngine.Vector3 ___right00;
	public UnityEngine.Vector3 ___right01;
	public void Update(float dt, World world) {
...
return;	}else
	...
	goto case 1;	}
	case 1:
	___forward00 = UnityCamera.Forward;
	UnityCamera.Position = ((UnityCamera.Position) + (((((new UnityEngine.Vector3(___forward00.x,0f,___forward00.z)) * (2f))) * (dt))));
	s000 = -1;
return;	
	default: return;}}
...
return;	}else
	...
	goto case 1;	}
	case 1:
	___forward01 = UnityCamera.Forward;
	UnityCamera.Position = ((UnityCamera.Position) - (((((new UnityEngine.Vector3(___forward01.x,0f,___forward01.z)) * (2f))) * (dt))));
	s001 = -1;
return;	
	default: return;}}
...
return;	}else
	...
	goto case 1;	}
	case 1:
	___right00 = UnityCamera.Right;
	UnityCamera.Position = ((UnityCamera.Position) + (((((new UnityEngine.Vector3(___right00.x,0f,___right00.z)) * (2f))) * (dt))));
	s002 = -1;
return;	
	default: return;}}
...
return;	}else
	...
	goto case 1;	}
	case 1:
	___right01 = UnityCamera.Right;
	UnityCamera.Position = ((UnityCamera.Position) - (((((new UnityEngine.Vector3(___right01.x,0f,___right01.z)) * (2f))) * (dt))));
	s003 = -1;
return;	
	default: return;}}
...
return;	}else
	...
	goto case 0;	}
	case 0:
	UnityCamera.Rotation = ((UnityEngine.Quaternion.Euler(0f,(60f) * (dt),0f)) * (UnityCamera.Rotation));
	s110 = -1;
return;	
	default: return;}}
...
return;	}else
	...
	goto case 0;	}
	case 0:
	UnityCamera.Rotation = ((UnityCamera.Rotation) * (UnityEngine.Quaternion.Euler((-60f) * (dt),0f,0f)));
	s112 = -1;
return;	
	default: return;}}
